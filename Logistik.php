...
<body>
    ...
    <div class="container">
        ...
        <main>
            ...
            <form method="GET" action="Logistik.php" style="text-align: center;">
            ...
            <table border="0" align="center" width="1900px" height="500px">
                ...
                <tbody>
                    ...
                    if(isset($_GET['kata_cari'])) {
                        ...
                        $query = "SELECT * FROM logistik WHERE `Nomor Surat` LIKE '%$kata_cari%' OR `Judul` LIKE '%$kata_cari%' ORDER BY `Nomor Surat` ASC LIMIT 10";
                    } else {    
                        $query = "SELECT * FROM logistik ORDER BY `id` ASC";
                    }
