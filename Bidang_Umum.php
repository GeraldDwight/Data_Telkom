...
<body>
    ...
    <div class="container">
        ...
        <main>
            ...
            <form method="GET" action="Bidang_Umum.php" style="text-align: center;">
            ...
            <table border="0" align="center" width="1900px" height="500px">
                ...
                <tbody>
                    ...
                    if(isset($_GET['kata_cari'])) {
                        ...
                        $query = "SELECT * FROM bidang_umum WHERE `Nomor Surat` LIKE '%$kata_cari%' OR `Judul` LIKE '%$kata_cari%' ORDER BY `Nomor Surat` ASC";
                    } else {
                        $query = "SELECT * FROM bidang_umum ORDER BY `id` ASC";
                    }
